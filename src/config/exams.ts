...
export const exams: ExamConfig[] = [
  // --- College Admissions ---
  {
    ...
    queryModifiers: ['study group', 'prep', 'practice questions', 'study discord', 'telegram group', 'whatsapp study group'],
  },
  {
    ...
    queryMarkets: ['US', 'global-english'],
    queryModifiers: ['study group', 'preparation', 'discord server', 'study community'],
  },
  {
  ...
  // --- Graduate Admissions ---
  {
    ...
    queryModifiers: ['study', 'discord server', 'telegram group', 'vocabulary group', 'quant study community', 'whatsapp study group'],
  },
  {
    ...
    queryMarkets: ['global-english'],
    queryModifiers: ['study group', 'discord server', 'telegram', 'focus study group', 'whatsapp group'],
  },
  ...
  // --- English Proficiency ---
  {
    ...
    queryMarkets: ['global-english'],
    queryModifiers: ['telegram group', 'study', 'speaking practice', 'preparation whatsapp group', 'writing community', 'discord server'],
  },
  {
    ...
    queryMarkets: ['global-english'],
    queryModifiers: ['telegram group', 'preparation', 'speaking study group', 'whatsapp community', 'discord'],
  },
  {
  ...
  // --- Medical & Healthcare ---
  {
    ...
    queryModifiers: ['discord server', 'study group', 'telegram group', 'preparation community', 'accountability group'],
  },
  {
    ...
    queryMarkets: ['US', 'global-english'],
    queryModifiers: ['telegram group', 'step 1', 'step 2 study group', 'preparation community', 'whatsapp study group'],
  },
  {
    ...
    queryMarkets: ['US', 'CA', 'global-english'],
    queryModifiers: ['telegram group', 'discord study server', 'preparation community', 'rn study group', 'whatsapp group'],
  },
  {
  ...
  // --- Law ---
  {
    ...
    queryMarkets: ['US', 'CA', 'global-english'],
    queryModifiers: ['discord server', 'study group', 'preparation telegram', 'logic games community'],
  },
  {
  ...
  // --- Finance & Accounting ---
  {
    ...
    queryMarkets: ['global-english'],
    queryModifiers: ['study telegram', 'level 1', 'level 2 study group', 'exam telegram group', 'study community'],
  },
  {
    ...
    queryMarkets: ['US', 'global-english'],
    queryModifiers: ['exam discord', 'study group telegram', 'exam preparation community', 'candidates discord'],
  },
  {
  ...
  // --- Cloud Certifications ---
  {
    ...
    queryMarkets: ['global-english'],
    queryModifiers: ['certification', 'solutions architect study group', 'exam telegram group', 'cloud practitioner', 'certification study community'],
  },
  {
  ...
  // --- Cybersecurity Certifications ---
  {
    ...
    queryMarkets: ['global-english'],
    queryModifiers: ['study group', 'discord', 'sy0-701', 'certification study'],
  },
  {
    slug: 'comptia-a-plus', name: 'CompTIA A+', family: 'cybersecurity-certifications', priority: 'high',
  ...
  },
  {
    ...
    queryMarkets: ['global-english'],
    queryModifiers: ['study group', 'telegram', 'exam preparation community'],
  },
  {
  ...
  // --- Networking Certifications ---
  {
    ...
    queryMarkets: ['global-english'],
    queryModifiers: ['study group', 'telegram group', 'discord', 'cisco certification'],
  },
  {
  ...
  // --- Project Management ---
  {
    ...
    queryMarkets: ['global-english'],
    queryModifiers: ['study group', 'discord', 'telegram group', 'exam preparation community'],
  },
  {
